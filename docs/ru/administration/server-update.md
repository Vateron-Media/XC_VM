...
Предлагаемые версии зависят от канала обновления сервера: на канале `stable` отображаются только стабильные версии; на канале `beta` вы также видите предварительные версии `(beta)`.
