...
- 🛡 **Администрирование**
  ...
  - [⚙️ Механизм обновлений](ru-ru/administration/update-system.md)
...
- 📘 **Инфо и Эксплуатация**
  ...
  - [🎬 Watch Folder (автоимпорт)](ru-ru/info/watch_folder.md)
  - [🧩 Бэклог пробелов в документации](ru-ru/info/documentation_gaps.md)

- 🧠 **Системная документация**
  - [📘 Обзор системной документации](ru-ru/system/README.md)
  - [🧭 Рендер navbar в панели модулей](ru-ru/system/modules-navbar-rendering.md)
