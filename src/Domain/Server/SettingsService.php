...
class SettingsService {
	...
	public static function edit(array $rData) {
		...
		if (isset($rData['responsive_tables'])) {
			$rArray['disable_table_responsive'] = 0;
		} elseif ($isFullForm) {
			$rArray['disable_table_responsive'] = 1;
		}
		...
		if (isset($rArray['language']) && class_exists(Translator::class)) {
