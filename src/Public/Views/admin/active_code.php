            ...
            <div class="card-body p-4">
                <form id="admin-active-code-form">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label fw-semibold" for="forced_country"><?= $language::get('ac_forced_geo_lock_country') ?? 'Forced Geo-Lock Country' ?> <i title="<?= $language::get('force_user_to_connect_to_tooltip'); ?>" class="icon-base ti tabler-help-circle text-secondary"></i></label>
                            <select name="forced_country" id="forced_country" class="form-select select2">
                                <option value=""><?= $language::get('ac_country_example') ?: 'None / Any' ?></option>
                                <?php foreach (\XcVm\Core\Reference\GeoReference::countries() as $rCountry): ?>
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body p-4">
                ...
                <div class="p-3 rounded-3 border mb-3" style="background: rgba(115, 103, 240, 0.05); border-color: rgba(115, 103, 240, 0.25) !important;">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-1 small">
                        <span class="text-muted"><?= $language::get('ac_forced_geo_lock_country') ?? 'Geo-Lock Country' ?>:</span>
