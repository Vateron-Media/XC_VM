...
<div class="row g-4 mb-4">
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="text-muted fw-normal small text-uppercase mb-1">Total Codes</h6>
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="text-muted fw-normal small text-uppercase mb-1">Unused Stock</h6>
...
<div class="card shadow-sm border-0">
    <div class="card-header border-bottom d-flex flex-wrap justify-content-between align-items-center gap-3">
        <div>
            <h5 class="card-title mb-1"><i class="ti tabler-folders text-primary me-2"></i>Voucher Batches (All Resellers)</h5>
            <p class="text-muted small mb-0">System-wide batch operations, scratch card exporting, and inventory audit.</p>
        </div>
    ...
    <div class="card-body p-0">
        <?php if (empty($batches)): ?>
            <div class="text-center py-5">
                ...
                <p class="text-muted">Generate a batch of active codes to start managing vouchers.</p>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>Package</th>
                            <th style="min-width: 200px;">Breakdown</th>
                            <th>Date Created</th>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <a href="active_codes?batch=<?= urlencode($bName); ?>" class="d-block small text-muted text-decoration-none">
                                                View codes <i class="ti tabler-arrow-right small"></i>
                                            </a>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: <?= $stockPct; ?>%"></div>
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $activePct; ?>%"></div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        <a href="./api?action=active_codes_export_txt&batch_name=<?= urlencode($bName); ?>" class="btn btn-sm btn-outline-primary" title="Export Scratch Card Vouchers .txt">
                                            <i class="ti tabler-printer me-1"></i>Export
                                        </a>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger btn-batch-delete" href="#" data-batch="<?= htmlspecialchars($bName, ENT_QUOTES); ?>">
...
(function($) {
    'use strict';
    $(function() {
        $('.btn-batch-enable').on('click', function(e) {
        e.preventDefault();
        execAdminBatchAction(jQuery(this).data('batch'), 'mass_enable');
    });

    jQuery('.btn-batch-disable').on('click', function(e) {
        e.preventDefault();
        execAdminBatchAction(jQuery(this).data('batch'), 'mass_disable');
    });

    jQuery('.btn-batch-delete').on('click', function(e) {
        e.preventDefault();
        const batch = jQuery(this).data('batch');
        if (confirm(`Are you sure you want to delete batch "${batch}" and all its codes?`)) {
