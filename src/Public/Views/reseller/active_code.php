            ...
            currentGeneratedCodes.forEach((c, idx) => {
                html += `
                    <tr>
                        <td>${idx + 1}</td>
                        <td>
                            <code class="fw-bold font-monospace text-primary fs-6">${escHtml(c.code)}</code>
                            <button type="button" class="btn btn-sm btn-icon btn-text-secondary btn-copy-one" data-code="${escHtml(c.code)}"><i class="ti tabler-copy"></i></button>
                        </td>
