 ...
 * reseller/header.newui.php and loads the core Bootstrap 5 script set.
 *
 * Mirrors admin/footer.newui.php: only the layout-critical vendors load here
 * (jQuery, Popper, Bootstrap, Waves, PerfectScrollbar, Hammer, menu.js, main.js)
 * plus the per-page vendor bundles resolved from the shared admin/vendors.newui.php
 * registry. Pages initialise their own plugins.
 *
 * Reached only for reseller pages opted in via xc_reseller_use_newui()
 * (see layouts/admin.php); every other reseller page keeps the legacy footer.php.
