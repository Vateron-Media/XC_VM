 ...
 *
 * Mirrors admin/header.newui.php but for the reseller surface: the reseller has
 ...
 *
 * Rendered by renderUnifiedLayoutHeader('reseller') only for pages opted in via
 * xc_reseller_use_newui() (see layouts/admin.php); every other reseller page
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-xxl navbar-detached navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center justify-content-between w-100" id="navbar-collapse">
                        ...
                        <!-- Left: live header stats (polled by footer.newui.php) -->
