...
(function () {
	function anecdote_constructor() {
		...
		this.init = function () {
			...
			var anecdote_body_container = create_block_element(
			...
			this.scrollbar = new scrollbar(anecdote_body_container, this.anecdote_body, {
				height: 330,
			});
		};
		...
		this.fill_page_bar = function () {
			...
			this.anecdote_page_bar.innerHTML =
				word["anecdote_pagebar_title"] +
		...
		this.init_quick_page_switch = function () {
			...
			this.quick_page_switch.input = create_block_element(
				"quick_page_input",
				this.quick_page_switch.dom_obj
			);
			...
			if (this.quick_page_switch.input.innerHTML.length <= 4) {
				if (this.quick_page_switch.input.innerHTML.length == 0 && num == 0) {
					...
					this.quick_page_switch.input.innerHTML =
						this.quick_page_switch.input.innerHTML + "" + num;
				}
			}
		...
		this.del_quick_go_page = function () {
			...
			this.quick_page_switch.input.innerHTML = this.quick_page_switch.input.innerHTML.substr(
				0,
				this.quick_page_switch.input.innerHTML.length - 1
			);
		};
