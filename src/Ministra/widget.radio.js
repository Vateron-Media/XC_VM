	...
	module.radio_widget = {
		...
		bind: function () {
			...
			(function (dir) {
					...
					try {
						if (typeof self.get_result.data[idx] == "object") {
							...
							stb.player.radio_idx =
								idx - (cur_media_item.page - 1) * self.get_result.max_page_items;
							stb.player.cur_media_item = cur_media_item;
							module.radio.cur_row = stb.player.radio_idx;
							stb.player.cur_media_item.playing = module.radio.data_items[
								stb.player.radio_idx
							].playing = 1;
							stb.player.cur_media_item.paused = module.radio.data_items[
								stb.player.radio_idx
							].paused = 0;
				...
				.bind(key.CHANNEL_NEXT, this, 1)
				.bind(key.CHANNEL_PREV, this, -1);
		},
