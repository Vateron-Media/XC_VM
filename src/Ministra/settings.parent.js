...
(function () {
	...
	function parent_settings_constructor() {
		...
		this.save = function () {
			...
			if (
				stb.user.parent_password == this.get_input_value("parent_password") &&
				this.get_input_value("pass") == this.get_input_value("repeat_pass")
			) {
	...
	parent_settings.add_control(
		new TextInput(parent_settings, {
