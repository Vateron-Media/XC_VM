	...
	main_menu.add(
		...
		function () {
			if (connection_problem && connection_problem.on) {
				...
				_debug(
					"stb.profile.enable_setting_access_by_pass",
					stb.profile.enable_setting_access_by_pass
				);
				var url =
					...
					"/" +
					stb.portal_path +
					"/external/settings/index.html?ajax_loader=" +
					stb.ajax_loader;
				...
				url +=
					"&enable_setting_access_by_pass=" + stb.profile.enable_setting_access_by_pass;
