...
(function () {
	...
	vclub.sidebar.dependency = [
		vclub.sort_menu,
		vclub.search_box,
		vclub.view_menu,
		vclub.other_menu,
	];
	vclub.sort_menu.dependency = [
		vclub.sidebar,
		vclub.search_box,
		vclub.view_menu,
		vclub.other_menu,
	];
	vclub.search_box.dependency = [
		vclub.sidebar,
		vclub.sort_menu,
		vclub.view_menu,
		vclub.other_menu,
	];
	vclub.view_menu.dependency = [
		vclub.sidebar,
		vclub.sort_menu,
		vclub.search_box,
		vclub.other_menu,
	];
	vclub.other_menu.dependency = [
		vclub.sidebar,
		vclub.sort_menu,
		vclub.search_box,
		vclub.view_menu,
