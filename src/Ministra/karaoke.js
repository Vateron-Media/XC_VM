...
(function () {
	...
	function karaoke_constructor() {
		...
		this.del_from_fav = function () {
			...
			var fav_karaoke_idx = stb.player.fav_karaoke.getIdxByVal(
				"id",
	...
	karaoke.init_sort_menu(
		[
			...
			{
				label: word["karaoke_only_favorite"],
				cmd: function () {
	...
	karaoke.init_fav_menu(fav_menu_map, {
		color: "yellow",
	...
	karaoke.init_other_menu(
		[
			{
				label: word["karaoke_search_box"],
				cmd: function () {
					this.parent.search_box_switcher();
				},
			},
			{
				label: word["karaoke_sampling"],
				cmd: function () {
